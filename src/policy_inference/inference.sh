...
POLICY_MODEL_PATH=/fs/scratch/rb_bd_dlp_rng-dl01_cr_AIM_employees/cache/huggingface/hub/models--Qwen--Qwen2.5-7B-Instruct/snapshots/a09a35458c702b33eeacc393d103063234e8bc28  ##${NEW_HOME}/hf_models/${LM}
...
HOST_ADDR=127.0.0.1 #10.124.70.140 #127.0.0.1 #0.0.0.0
CONTROLER_PORT=21001
WORKER_BASE_PORT=21002
controller_addr=http://${HOST_ADDR}:21001
...
bash ${PYTHONPATH}/reward_generation/vllm_fc_serve.sh $POLICY_MODEL_PATH $VALUE_MODEL_PATH $HOST_ADDR $CONTROLER_PORT $WORKER_BASE_PORT $LOGDIR
...
for split in train; do
    ...
    if [ "$loop" == "1" ]; then
        ...
        python policy_inference/policy_inference.py \
